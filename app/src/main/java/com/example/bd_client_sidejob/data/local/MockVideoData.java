...
public class MockVideoData {
    ...
    private static Video newVideo(long id, int urlIndex, String title, String author,
    ...
    public static List<Video> getMockVideos() {
        ...
        list.add(newVideo(1, 0, "大兔子先生的奇幻冒险之旅", "动画工房",
                52340, 3840, 12400, 860));

        list.add(newVideo(2, 1, "大象的梦想 - 动画短片", "梦想工作室",
                89100, 6200, 25000, 2100));

        list.add(newVideo(3, 2, "熊熊燃烧的激情岁月", "燃烧视觉",
                45600, 3100, 18900, 1200));

        list.add(newVideo(4, 3, "更大规模的逃脱计划行动", "逃脱大师",
                120500, 9100, 43500, 4500));

        list.add(newVideo(5, 4, "欢乐时光无限精彩剪辑", "欢乐制造机",
                34500, 2300, 11200, 780));

        list.add(newVideo(6, 5, "刺激的驾乘体验实录", "速度与激情",
                67800, 4500, 21000, 1800));

        list.add(newVideo(7, 6, "冰川融化的警示纪录片", "冰川记录者",
                98000, 7200, 34000, 5200));

        list.add(newVideo(8, 7, "精灵与剑的传说故事", "剑与魔法",
                56000, 3900, 19800, 1500));

        list.add(newVideo(9, 8, "斯巴鲁傲虎街道与越野测评", "汽车评测官",
                78900, 5600, 28000, 3200));

        list.add(newVideo(10, 9, "钢铁之泪 - 科幻巨作短片", "科幻影院",
                134000, 10500, 56200, 8900));

        list.add(newVideo(11, 10, "大众GTI深度评测体验", "专业车评",
                45600, 3800, 15600, 2100));

        list.add(newVideo(12, 11, "疯狂越野之旅全程记录", "越野探险家",
                67000, 4800, 23000, 3400));

        list.add(newVideo(13, 12, "一万元能买什么车？实测", "实惠购车指南",
                89000, 7200, 31000, 5600));

        list.add(newVideo(14, 13, "大兔子先生的奇幻冒险续集", "动画工坊",
                41000, 2900, 13400, 1100));

        list.add(newVideo(15, 14, "大象的梦想 - 重制版全集", "梦想动画",
                96000, 8100, 37000, 4800));

        list.add(newVideo(16, 15, "美食探店 - 隐藏在巷子里的川味", "美食家小红",
                125000, 9800, 45000, 6700));

        list.add(newVideo(17, 16, "旅行Vlog - 云南大理七日游", "旅行者小明",
                187000, 13200, 78000, 12500));

        list.add(newVideo(18, 17, "舞蹈教学入门 - 零基础学街舞", "舞蹈精灵小美",
                98000, 6700, 35000, 4300));

        list.add(newVideo(19, 18, "宠物日常 - 我家柯基的快乐一天", "宠物博主阿花",
                213000, 18500, 96000, 23000));

        list.add(newVideo(20, 19, "美妆教程 - 三分钟快速出门妆", "穿搭女王",
                156000, 11500, 62000, 8900));

        list.add(newVideo(21, 20, "数码评测 - 新旗舰手机深度体验", "科技达人阿强",
                234000, 19200, 89000, 15600));

        list.add(newVideo(22, 21, "极限运动集锦 - 滑板少年的街头", "极限挑战者",
                112000, 7800, 41000, 5400));

        list.add(newVideo(23, 22, "街头采访 - 路人眼中的爱情观", "街头艺术家",
                89000, 6100, 28000, 3700));

        list.add(newVideo(24, 23, "生活妙招 - 十个厨房清洁小技巧", "家居改造王",
                178000, 14500, 67000, 11200));

        list.add(newVideo(25, 24, "摄影教学 - 手机也能拍出大片感", "摄影大师",
                145000, 10200, 54000, 7800));

        list.add(newVideo(26, 25, "音乐弹奏 - 指弹吉他版告白气球", "音乐梦想家",
                201000, 16800, 83000, 14500));

        list.add(newVideo(27, 26, "手工制作 - 废纸盒变身收纳神器", "手工匠人",
                167000, 13400, 61000, 9800));

        list.add(newVideo(28, 27, "游戏实况 - 新游开荒全程解说", "游戏高手",
                256000, 21500, 97000, 18900));

        list.add(newVideo(29, 28, "读书分享 - 三本改变人生的好书", "读书人",
                134000, 9800, 48000, 6500));

        list.add(newVideo(30, 29, "穿搭灵感 - 春季通勤搭配一周不重样", "穿搭女王",
                189000, 15200, 72000, 11300));

        list.add(newVideo(31, 30, "家居改造 - 出租屋也能变精致小窝", "家居改造王",
                223000, 19800, 94000, 17800));

        list.add(newVideo(32, 31, "职场心得 - 互联网大厂三年经验分享", "数码先锋",
                98000, 7300, 32000, 4100));

        list.add(newVideo(33, 32, "情感故事 - 十年异地恋的坚持与结局", "情感导师",
                345000, 32000, 156000, 42000));

        list.add(newVideo(34, 33, "科普冷知识 - 你可能不知道的十个事实", "科普君",
                278000, 24500, 112000, 21000));

        list.add(newVideo(35, 34, "厨艺教学 - 年夜饭硬菜东坡肉完整教程", "厨艺大师",
                190000, 15600, 75000, 13200));

        list.add(newVideo(36, 35, "健身入门 - 在家也能练出马甲线", "健身教练",
                312000, 28500, 134000, 25600));

        list.add(newVideo(37, 36, "汽车试驾 - 特斯拉Model3山路实测", "汽车评测官",
                156000, 11800, 54000, 8900));

        list.add(newVideo(38, 37, "爆笑集锦 - 本年度最搞笑失误视频合集", "欢乐制造机",
                456000, 43000, 198000, 56000));

        list.add(newVideo(39, 38, "穿越题材短剧 - 带着手机回古代", "穿越剧场",
                234000, 19200, 86000, 14500));

        list.add(newVideo(40, 39, "短剧全集 - 霸总的意外恋人", "霸总剧场",
                387000, 35000, 167000, 38000));

        list.add(newVideo(41, 40, "逆袭人生 - 从普通职员到公司合伙人", "职场导师",
                198000, 16200, 78000, 13200));

        list.add(newVideo(42, 41, "闪婚玫瑰 - 先婚后爱的浪漫故事", "浪漫剧场",
                432000, 41000, 205000, 49000));

        list.add(newVideo(43, 42, "东北爱情故事 - 在冰天雪地里遇见你", "东北影视",
                267000, 23500, 112000, 21000));

        list.add(newVideo(44, 43, "赘婿翻身记 - 被瞧不起的人站起来了", "励志剧场",
                523000, 48000, 245000, 67000));

        list.add(newVideo(45, 44, "重生之商业帝国 - 回到十年前重新开始", "重生剧场",
                389000, 34500, 178000, 42000));

        list.add(newVideo(46, 45, "热门 - 宠物猫的搞笑日常合集", "宠物博主阿花",
                345000, 32000, 156000, 28000));

        list.add(newVideo(47, 46, "科技前沿 - 2026年AI将改变哪些行业", "科技达人阿强",
                298000, 27500, 134000, 23500));

        list.add(newVideo(48, 47, "美食Vlog - 广州早茶一条街吃到爽", "美食家小红",
                210000, 17800, 89000, 14500));

        list.add(newVideo(49, 48, "游戏实况 - 魂系新作的百次死亡之旅", "游戏高手",
                378000, 34000, 167000, 31000));

        list.add(newVideo(50, 49, "旅行Vlog - 北海道冬天的极致浪漫", "旅行者小明",
                267000, 24000, 123000, 21000));

        list.add(newVideo(51, 50, "数码开箱 - 最新降噪耳机横评对比", "数码先锋",
                123000, 9500, 45000, 6700));

        list.add(newVideo(52, 51, "手工教程 - 用废木板做个性书架", "手工匠人",
                89000, 6700, 34000, 4500));

        list.add(newVideo(53, 52, "舞蹈高阶 - Breaking地板技巧教学", "舞蹈精灵小美",
                145000, 11200, 56000, 7800));

        list.add(newVideo(54, 53, "美妆测评 - 十款平价口红真实试色", "穿搭女王",
                198000, 16500, 78000, 12300));

        list.add(newVideo(55, 54, "摄影技巧 - 如何拍出唯美逆光人像", "摄影大师",
                112000, 8900, 41000, 5600));

        list.add(newVideo(56, 55, "音乐弹唱 - 原创歌曲创作全过程", "音乐梦想家",
                156000, 12300, 61000, 8900));

        list.add(newVideo(57, 56, "极限运动 - 翼装飞行第一视角实录", "极限挑战者",
                345000, 31000, 156000, 32000));

        list.add(newVideo(58, 57, "科普动画 - 黑洞到底长什么样", "科普君",
                289000, 26000, 134000, 23000));

        list.add(newVideo(59, 58, "厨艺挑战 - 100元做四菜一汤", "厨艺大师",
                167000, 13400, 65000, 9800));

        list.add(newVideo(60, 59, "健身进阶 - 杠铃深蹲完整技术分析", "健身教练",
                234000, 19800, 95000, 16700));

        list.add(newVideo(61, 60, "读书感悟 - 活着带给我的人生启示", "读书人",
                89000, 6500, 31000, 4200));

        list.add(newVideo(62, 61, "家居DIY - 旧物翻新大改造全记录", "家居改造王",
                145000, 11500, 56000, 7800));

        list.add(newVideo(63, 62, "汽车对比 - 30万预算买油车还是电车", "汽车评测官",
                189000, 15600, 72000, 11500));

        list.add(newVideo(64, 63, "动画短片 - 都市孤独症的故事", "动画工坊",
                98000, 7200, 36000, 5400));

        list.add(newVideo(65, 64, "搞笑短剧 - 办公室搞笑日常第三季", "欢乐制造机",
                278000, 25000, 123000, 21000));

        list.add(newVideo(66, 65, "热血漫剪 - 年度最燃动漫剪辑合集", "燃烧视觉",
                456000, 42000, 210000, 54000));

        list.add(newVideo(67, 66, "温情短片 - 父亲写给女儿的一封信", "冰川记录者",
                389000, 36000, 178000, 45000));

        list.add(newVideo(68, 67, "治愈系Vlog - 一个人的周末慢生活", "摄影大师",
                198000, 16200, 82000, 13400));

        list.add(newVideo(69, 68, "科幻短片 - AI觉醒的第一天发生了什么", "科幻影院",
                312000, 28500, 145000, 27800));

        list.add(newVideo(70, 69, "极限越野 - 穿越可可西里无人区", "越野探险家",
                267000, 24000, 123000, 21000));

        list.add(newVideo(71, 70, "剑道修行 - 日本古剑术入门体验", "剑与魔法",
                89000, 6400, 31000, 4200));

        list.add(newVideo(72, 71, "逃脱游戏 - 密室逃脱通关全纪录", "逃脱大师",
                134000, 10200, 48000, 6500));

        list.add(newVideo(73, 72, "购车指南 - 家庭第一辆车该怎么选", "实惠购车指南",
                178000, 14500, 67000, 9800));

        list.add(newVideo(74, 73, "动画连载 - 大兔子先生第三季第一集", "动画工房",
                234000, 19800, 95000, 15600));

        list.add(newVideo(75, 74, "梦想纪实 - 普通人的非凡人生故事", "梦想工作室",
                167000, 13400, 64000, 8900));

        list.add(newVideo(76, 75, "宠物养成 - 两个月大的金毛到家第一天", "宠物博主阿花",
                345000, 32000, 156000, 28000));

        list.add(newVideo(77, 76, "数码前沿 - 折叠屏手机的第三次革命", "科技达人阿强",
                212000, 17800, 89000, 14800));

        list.add(newVideo(78, 77, "旅行攻略 - 泰国清迈1000元玩三天", "旅行者小明",
                298000, 27000, 134000, 23000));

        list.add(newVideo(79, 78, "情感疗愈 - 分手后如何走出低谷期", "情感导师",
                423000, 39000, 189000, 45000));

        list.add(newVideo(80, 79, "职场进阶 - 面试时绝对不能说的五句话", "数码先锋",
